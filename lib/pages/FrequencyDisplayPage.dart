...
class FrequencyDisplayPage extends StatefulWidget {
  var datas;

  FrequencyDisplayPage({super.key, required this.datas});

  @override
  State<FrequencyDisplayPage> createState() => _FrequencyDisplayPageState();
}

class _FrequencyDisplayPageState extends State<FrequencyDisplayPage>
  ...
  void initState() {
    ...
    // Scale animation for frequency text
    ...
    // Rotate animation for the frequency reading text
  ...
  Future<void> _refreshData() async {
    ...
    var newData = await FetchingApi().fetchData(); // Ensure you have the correct FetchingApi
        ...
        child: AnimatedBuilder(
          ...
          builder: (context, child) {
            return Transform.scale(
              scale: 1 + (_controller.value * 0.3), // Scale the button on refresh
